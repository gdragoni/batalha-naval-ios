...
-(void)addPlayer:(NSString *)playerName{
    ...
    if ([ValidatePlayerName nameWithInvalidCharacters:playerName]) {
        ...
        alert = [[UIAlertView alloc]initWithTitle:@"Tamanho inválido" message:@"Nome deve ter mais de 3 cacteres e menos de 25." delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
